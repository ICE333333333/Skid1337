...
namespace colors
{
	inline ImVec4 accent = ImColor( 255, 0, 8 );
	...
	inline ImVec4 child_label = ImColor(255, 0, 8);

	inline ImVec4 listbox_background = ImColor(14, 14, 14);
	inline ImVec4 listbox_border = ImColor(20, 20, 20);
	inline ImVec4 listbox_label_active = ImColor(255, 0, 8);
	inline ImVec4 listbox_label_inactive = ImColor(255, 0, 8);

	inline ImVec4 scrollbar_background = ImColor(14, 14, 14);
	inline ImVec4 scrollbar_background_two = ImColor(15, 15, 15);

	inline ImVec4 tab_icon = ImColor(255, 0, 8);
	inline ImVec4 subtab_col = ImColor(20, 20, 20);

	inline ImVec4 checkbox_label_active = ImColor(255, 0, 8);
	inline ImVec4 checkbox_label_inactive = ImColor(255, 0, 8);
	inline ImVec4 checkbox_background = ImColor(18, 18, 18);
	inline ImVec4 checkbox_outline = ImColor(22, 22, 22);

	inline ImVec4 slider_label = ImColor(255, 0, 8);
	inline ImVec4 slider_background = ImColor(18, 18, 18);
	inline ImVec4 slider_outline = ImColor(22, 22, 22);
	inline ImVec4 slider_circle_fadein = ImColor(255, 0, 8);
	inline ImVec4 slider_circle_fadeout = ImColor(255, 0, 8);

	inline ImVec4 combo_label = ImColor(255, 0, 8);
	inline ImVec4 combo_background = ImColor(18, 18, 18);
	inline ImVec4 combo_outline = ImColor(22, 22, 22);
	inline ImVec4 combo_arrow = ImColor(255, 0, 8);

	inline ImVec4 selectable_label_active = ImColor(255, 0, 8);
	inline ImVec4 selectable_label_inactive = ImColor(255, 0, 8);
	inline ImVec4 selectable_background = ImColor(20, 20, 20);
	inline ImVec4 selectable_outline = ImColor(25, 25, 25);

	inline ImVec4 input_label = ImColor(255, 0, 8);
	inline ImVec4 input_background = ImColor(18, 18, 18);

	inline ImVec4 button_label_active = ImColor(255, 0, 8);
	inline ImVec4 button_label_inactive = ImColor(255, 0, 8);
	inline ImVec4 button_background = ImColor(16, 16, 16);
	inline ImVec4 button_outline = ImColor(21, 21, 21);

	inline ImVec4 color_label = ImColor(255, 0, 8);
	inline ImVec4 color_background = ImColor(8, 8, 8);

	inline ImVec4 key_label = ImColor(255, 0, 8);
